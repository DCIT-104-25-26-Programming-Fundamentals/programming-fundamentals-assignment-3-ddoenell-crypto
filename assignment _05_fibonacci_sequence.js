...
// Generates the first N Fibonacci numbers using a loop and prints them
// on one line.
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Function: isFibonacciNumber
// Generates Fibonacci numbers with a loop, stopping once the generated
// value reaches or passes the target number, then checks for a match.
// -----------------------------------------------------------------------------
...
function main() {
  ...
  const target = parseInt(readlineSync.question("Enter a number to check: "));

  if (isNaN(target) || target < 0) {
    console.log("Error: Please enter a valid non-negative number.");
  } else if (isFibonacciNumber(target)) {
