...
// -----------------------------------------------------------------------------
// Function: addTask
// Prompts the user for a task description, adds it to the array, and
...
// -----------------------------------------------------------------------------
// Function: viewTasks
// Displays all tasks numbered from 1, or a friendly message if empty.
// -----------------------------------------------------------------------------
function viewTasks() {
  if (tasks.length === 0) {
...
// -----------------------------------------------------------------------------
// Function: deleteTask
// Shows the current tasks, asks which one to remove, then removes it
// with splice. Handles invalid task numbers gracefully.
// -----------------------------------------------------------------------------
function deleteTask() {
  if (tasks.length === 0) {
  ...
  viewTasks();
  const taskNumber = parseInt(readlineSync.question("Enter task number to delete: "));
  const index = taskNumber - 1;

  if (isNaN(taskNumber) || index < 0 || index >= tasks.length) {
